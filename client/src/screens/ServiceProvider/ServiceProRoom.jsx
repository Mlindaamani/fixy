...
//                     tabIndex={0}
//                     onKeyDown={(e) =>
//                       e.key === "Enter" && handleUserClick(user)
//                     }
//                   >
...
//       <div className="flex flex-1">
//         {/* Sidebar */}
//         <div className="fixed top-0 left-0 w-80 h-screen bg-white border-r border-gray-200 p-4 flex flex-col z-10">
//           <div className="flex items-center justify-between mb-4">
//             <h5 className="text-lg font-semibold text-gray-800">Chats</h5>
//             <label className="relative inline-flex items-center cursor-pointer">
//               <input
...
//         {/* Chat Area */}
//         <div className="ml-80 flex-1 flex flex-col bg-gray-100">
//           {/* Messages */}
//           <div className="flex-1 p-6 overflow-y-auto">
//             {!selectedUser ? (
//               <div className="h-full flex items-center justify-center">
...
//       {/* Sidebar */}
//       <div className="fixed top-16 left-64 w-80 h-[calc(100vh-4rem)] bg-white border-r border-gray-200 p-4 flex flex-col z-10">
//         <div className="flex items-center justify-between mb-4">
//           <h5 className="text-lg font-semibold text-gray-800">Chats</h5>
//           <label className="relative inline-flex items-center cursor-pointer">
//             <input
...
const ServiceProRoom = () => {
  ...
  const handleUserClick = (user) => {
    setSelectedUser(user);
    getMessages();
    setIsChatSidebarOpen(false); // Close sidebar on mobile after selection
  };
