            ...
            <div className="lg:w-1/4">
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <div className="mb-6">
                  ...
                  <select
                    className="w-full px-4 py-2 rounded-lg border-none text-sm"
                ...
                <div className="mb-6">
                  ...
                  <div className="flex items-center space-x-4">
                    <input
                      ...
                      className="w-24 px-3 py-2 rounded-lg border-none text-sm"
                      min="0"
                    />
                    <span>to</span>
                    <input
                ...
                <button
                  ...
                  className="!rounded-button w-full bg-gray-100 text-gray-600 px-4 py-2 hover:bg-gray-200 transition-colors whitespace-nowrap"
                >
                  Clear All Filters
                </button>
              </div>
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex space-x-4">
                        <button
                          ...
                          className="!rounded-button flex-1 bg-white border-2 border-indigo-600 text-indigo-600 px-4 py-2 hover:bg-indigo-50 transition-colors whitespace-nowrap"
                        >
                          View Profile
                        </button>
                        <button className="!rounded-button flex-1 bg-indigo-600 text-white px-4 py-2 hover:bg-indigo-700 transition-colors whitespace-nowrap">
                          Book Now
                        </button>
                      </div>
                    </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
          <div className="bg-white rounded-xl p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-2">
                {selectedProfessional.specialties.map(
            ...
            <div className="flex space-x-4">
              <button className="!rounded-button flex-1 bg-white border-2 border-indigo-600 text-indigo-600 px-6 py-3 hover:bg-indigo-50 transition-colors whitespace-nowrap">
                <i className="fas fa-phone-alt mr-2"></i>
                Contact
              </button>
              <button className="!rounded-button flex-1 bg-indigo-600 text-white px-6 py-3 hover:bg-indigo-700 transition-colors whitespace-nowrap">
