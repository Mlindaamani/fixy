      ...
      <div className="w-full mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/services" className="no-underline text-white">
              Services
            </Link>
            <Link to="/contact" className="no-underline text-white">
              Contact
            </Link>
            <Link to="/professionals" className="no-underline text-white">
              Professionals
            </Link>
            {isAuthenticated ? (
              <>
                <Link to={navigateTo(user)} className="no-underline text-white">
                  Dashboard
                </Link>

                <button
                  onClick={() => logout(navigate)}
                  className="!rounded-full bg-indigo-400 text-white px-6 py-2 hover:bg-indigo-600 transition-colors cursor-pointer whitespace-nowrap"
                >
                  Logout
                </button>
              </>
